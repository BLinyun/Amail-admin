    ...
    children: [
      {
        path: 'out',
        name: '呼出记录',
        component: () => import('@/views/callrecords/out'),
        meta: { title: '呼出记录', icon: 'form' }
      },
      {
        path: 'incoming',
        name: '呼入记录',
        component: () => import('@/views/callrecords/incoming'),
        meta: { title: '呼入记录', icon: 'form' }
      },
      {
        path: 'customer',
        name: '客户管理',
        component: () => import('@/views/callrecords/customer'),
        meta: { title: '客户管理', icon: 'form' }
      },
      {
        path: 'equipment',
        name: '设备管理',
        component: () => import('@/views/callrecords/equipment'),
